@extends('admin.admin_app', ['title' => 'Edit Roles', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])


@section('content')
@include('admin.shared/page-title',['page_title' => 'Edit Roles','sub_title' => 'Roles'])
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" id="editroles" action="{{ route('update.roles') }}">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="name" id="name" placeholder="permissionname" value="{{ $roles->name }}">
