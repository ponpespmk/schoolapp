...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Error 404 | SYTechID</title>
                                    ...
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <div class="p-4 my-auto">
                                            ...
                                            <div class="text-center">
                                                ...
                                                <h4 class="fs-20">Halaman Tidak Ditemukan</h4>
                                                <p class="text-muted mb-3"> Halaman yang anda tuju tidak ditemukan, silahkan hubungi admin untuk info lebih lanjut.!</p>
                                            </div>
